...
export default function Services() {
  ...
  return (
    <DashboardLayout>
      <PageMeta
        title="Services & Pricing — Grinzo"
        description="Browse Grinzo services: Instagram, YouTube, TikTok and Twitter/X engagement with transparent pricing and natural delivery."
