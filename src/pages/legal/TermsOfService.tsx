...
export default function TermsOfService() {
  return (
    <>
      <PageMeta title="Terms of Service | OrganicSMM Pro" description="Read the Terms of Service for OrganicSMM Pro platform." canonicalPath="/terms" breadcrumbs={[{ name: "Home", path: "/" }, { name: "Terms of Service", path: "/terms" }]} />
